...
const AboutMeText = () => {
  return (
    <div className='flex flex-col md:items-start sm:items-center md:text-left sm:text-center'>
      ...
      <p className='text-white'>I’m Kamya Gupta a fourth-year Computer Science student driven by curiosity and <br /> a passion for building user-friendly web applications.
...
<a 
  href="/Resume/Kamya _ Resume.pdf" 
//   download
  target="_blank" 
